// Place a unit-Y primitive (cylinder/capsule) along the segment a→b: the
// midpoint, the rotation from +Y to the segment direction, and the length.
// Copied from riglab's assembly/axis.ts.
