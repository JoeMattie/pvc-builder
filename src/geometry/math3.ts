// Minimal, dependency-free 3D vector/quaternion helpers. Kept framework-free
// (no three.js) so the geometry/composition layer stays a pure, fast-to-test
// module; the r3f UI converts these plain records to three objects at the
// boundary. Copied verbatim from riglab (planfile §2).
